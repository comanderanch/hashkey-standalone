...
Hash split into 4 identical streams
Each chunked proportionally
Neighbor alignment verification
Reconstruct from any 2 clean streams
Contribution: Anthony Hagerty +
              colleague insight
